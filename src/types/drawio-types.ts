...
declare interface DrawioGraph {
  ...
  setSelectionCells(cells: DrawioCell[]): void;
  importCells(cells: mxCell[], x: number, y: number): DrawioCell[];
  ...
  scrollCellToVisible(cell: DrawioCell): void;
