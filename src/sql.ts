...
Draw.loadPlugin(function(ui) {
     ...
     * @returns json
     */
    function GetColumnQuantifiers(type:string):ColumnQuantifiers {
        let chars = {
            Start: '"',
            End: '"',
        };
    ...
    function getMermaidDiagramDb(type: string):DbDefinition{
    ...
    function generateSql(type: string) {
    ...
    class SqlSimpleParser {
                ...
                // Parse Properties
                    ...
                    if (normalProperty) {
                        ...
                        if (this.MODE_SQLSERVER) {
                            ...
                            const columnQuantifiers = this.GetColumnQuantifiersFromDialect();
                            //Get delimiter of column name
         ...
         * @returns json
         */
        GetColumnQuantifiersFromDialect():ColumnQuantifiers {
            const chars = {
                Start: "\"",
                End: "\"",
            };
